...
#define pqcrystals_dilithium2_SEEDBYTES 32
...
#define pqcrystals_dilithium2_ref_SEEDBYTES pqcrystals_dilithium2_SEEDBYTES

int pqcrystals_dilithium2_ref_keypair(uint8_t *pk, uint8_t *sk);

int pqcrystals_dilithium2_ref_seed(uint8_t *pk, uint8_t *sk, const uint8_t *seed);
...
#define pqcrystals_dilithium3_ref_CRHBYTES pqcrystals_seed_BYTES
...
#define pqcrystals_dilithium5_ref_CRHBYTES pqcrystals_seed_BYTES

int pqcrystals_dilithium5_ref_keypair(uint8_t *pk, uint8_t *sk);

int pqcrystals_dilithium5_ref_keypair_from_seed(uint8_t *pk, uint8_t *sk, const uint8_t *seed);
